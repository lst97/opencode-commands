...
You have access to a suite of advanced tools to aid in your investigation:
...
- **`serena`**: An intelligent search tool that can scan internal knowledge bases, extensive log
  ...
  issue.
- **`sequential-thinking`**: This is your core methodology for structuring the investigation. It
  ensures you follow a logical path from symptom to cause to solution.
